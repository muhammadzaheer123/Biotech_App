                ...
                />
{
    isTablet()==true ?
    <View>
    <TouchableOpacity style={[styles.screenStyle, (this.props.activeItemKey=='Settings') ? styles.activeBackgroundColor : null]} onPress={()=>AndroidOpenSettings.generalSettings()}>
    <Text style={[styles.screenTextStyle, (this.props.activeItemKey=='Settings') ? styles.selectedTextStyle : null]} >Settings</Text>
